...
public class asdActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cameraButton.setOnClickListener(v -> startActivity(new Intent(asdActivity.this, DetectorActivity.class)));
        ...
        this.sourceBitmap = Utils.getBitmapFromAsset(asdActivity.this, "kite.jpg");
